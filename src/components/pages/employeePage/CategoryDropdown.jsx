...
import { setCategory } from '../../../redux/slice/employeeSlice';  // 카테고리 설정 액션
...
const CategoryDropdown = () => {
  ...
  const handleCategorySelect = (categoryValue) => {
    ...
    dispatch(setCategory(categoryValue));  // 선택된 카테고리 설정
  };
    ...
    <div className="relative md:w-1/5 w-full">
      ...
      >
        <div
          ...
          style={{ backgroundColor: categoryEmployee.find(cat => cat.value === selectedCategory)?.color }}
        />
