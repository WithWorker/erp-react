...
export const getApplicant = async (applicantId) => {
  try {
    const response = await axios.get(`/api/approval/applicant/${applicantId}`);
...
export const getApprover = async (approverId) => {
  try {
    const response = await axios.get(`/api/approval/approver/${approverId}`);
...
export const getApprovedList = async (statusId) => {
  try {
    const response = await axios.get(`/api/approval/approved/${statusId}`);
...
export const addApproval = async (approval) => {
  try {
    const response = await axios.post(`/api/approval/add`, approval);
    return response.data;  
  } catch (error) {
...
export const deleteapproval = async (approvalId) => {
  try {
    ...
    const response = await axios.delete(`/api/approval/${approvalId}`);
